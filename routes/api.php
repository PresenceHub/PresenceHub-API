...
use App\Domain\Auth\Http\Controllers\ForgotPasswordUserController;
...
use App\Domain\Auth\Http\Controllers\ResetPasswordUserController;
...
Route::prefix('v1')->name('v1.')->group(function () {
    ...
    Route::prefix('auth')->name('auth.')->group(function () {
        ...
        Route::post('/reset-password', ResetPasswordUserController::class)
            ->middleware('throttle:5,1')
            ->name('reset-password');
