...
class PostTargetPublishSucceeded extends DomainEvent implements ShouldBeRecorded, ShouldDispatchAfterCommit
{
    public const string NAME = 'post_target.publish.succeeded';
    ...
    public function getProperties(): array
    {
        return [
            ...
            'external_post_id' => $this->target->external_post_id,
        ];
    }
}
